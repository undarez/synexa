...
export function getDefaultWidgets(): WidgetConfig[] {
  return [
    // dailyBrief retiré car doublon avec le header
    { widgetType: "voiceCommand", size: "medium", position: 0, column: 1, row: 1, visible: true },
    { widgetType: "chatInterface", size: "medium", position: 1, column: 2, row: 1, visible: true },
    { widgetType: "events", size: "large", position: 2, column: 1, row: 2, visible: true },
    { widgetType: "wellness", size: "medium", position: 3, column: 2, row: 2, visible: true },
    { widgetType: "recommendations", size: "small", position: 4, column: 2, row: 3, visible: true },
    { widgetType: "networkDetector", size: "small", position: 5, column: 2, row: 4, visible: true },
    { widgetType: "tasks", size: "medium", position: 6, column: 1, row: 3, visible: true },
    { widgetType: "routines", size: "small", position: 7, column: 1, row: 4, visible: true },
  ];
}
