...
import { Wifi, Bluetooth, Loader2, CheckCircle2, AlertCircle } from "lucide-react";
    ...
    <Card>
      ...
      <CardContent className="space-y-4">
        ...
        <p className="text-xs text-zinc-500">
          💡 Note : La détection automatique est limitée dans les navigateurs web.
          Pour une détection complète, configurez manuellement dans votre profil.
        </p>
      </CardContent>
    </Card>
  );
